...
int main()
{
    Mat image = imread("/Users/John443/Project/Project1/Project1/Map.bmp", CV_LOAD_IMAGE_GRAYSCALE);
    //namedWindow("Map");
    //imshow("Map", image);
...
//    imshow("Blurred Map", blurred);
    imwrite("/Users/John443/Project/Project1/Project1/Blurred Map.bmp", blurred);
...
//    imshow("Threshold Map", thresh);
    imwrite("/Users/John443/Project/Project1/Project1/Threshold Map.bmp", thresh);
...
//    imshow("Contoured Map", contoured);
    imwrite("/Users/John443/Project/Project1/Project1/Contoured Map.bmp", contoured);
    cout << "Done" << endl;
//    waitKey(0);
    return 0;
}
